package com.go2plus.common.bean;
...
public final class BeanKit {
  ...
  /**
   * Fill the filed of target by the source source can be a Map<String,Object> or ServletRequest
   * 
   * @param target
   * @param source
   */
  ...
  /**
   * set the value to target by method m using reflection automatic type parse for String>Date String>Integer String>Long String>Double
   * 
   * @param m
   * @param value
   * @param target
  ...
  /**
   * get the value of specified key from Map<String,Object> or ServletRequest(parameter)
   * 
   * @param key
   * @param source
   * @return
