...
<html>
	<head>
		...
		<!-- basic styles -->
		<link href="http://localhost:8080/TPM/views/assets/css/bootstrap.min.css" rel="stylesheet" />
		<link rel="stylesheet" href="http://localhost:8080/TPM/views/assets/css/font-awesome.min.css" />
		...
		<link rel="stylesheet" href="http://localhost:8080/TPM/views/assets/css/ace-skins.min.css" />
...
<![endif]-->
		...
		<script src="http://localhost:8080/TPM/views/assets/js/bootstrap.min.js"></script>
		<script src="http://localhost:8080/TPM/views/assets/js/typeahead-bs2.min.js"></script>
		...
		<script src="http://localhost:8080/TPM/views/assets/js/jquery-ui-1.10.3.custom.min.js"></script>
		<script src="http://localhost:8080/TPM/views/assets/js/jquery.ui.touch-punch.min.js"></script>
		<script src="http://localhost:8080/TPM/views/assets/js/jquery.slimscroll.min.js"></script>
		<script src="http://localhost:8080/TPM/views/assets/js/jquery.easy-pie-chart.min.js"></script>
		<script src="http://localhost:8080/TPM/views/assets/js/jquery.sparkline.min.js"></script>
		<script src="http://localhost:8080/TPM/views/assets/js/flot/jquery.flot.min.js"></script>
		<script src="http://localhost:8080/TPM/views/assets/js/flot/jquery.flot.pie.min.js"></script>
		<script src="http://localhost:8080/TPM/views/assets/js/flot/jquery.flot.resize.min.js"></script>

		<!-- ace scripts -->

		<script src="http://localhost:8080/TPM/views/assets/js/ace-elements.min.js"></script>
		<script src="http://localhost:8080/TPM/views/assets/js/ace.min.js"></script>
