		...
		<div id="container">
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						<div id="box_top">搜索条件</div>
						<div id="box_center">
							设备编号
							<select name="fangyuanEntity.fyXqCode" id="fyXq" class="ui_select01" onchange="getFyDhListByFyXqCode();">
                                <option value=""
                                >--请选择--</option>
                                <option value="6">TPM1001</option>
                                <option value="77">TPM1001</option>
                                <option value="83">TPM1001</option>
                            </select>
							...
							<select name="fangyuanEntity.fyHxCode" id="fyHx" class="ui_select01">
                                <option value="">--请选择--</option>
                                <option value="76">TPM1001</option>
                                <option value="10">TPM1001</option>
                                <option value="14">TPM1001</option>
                                <option value="71">TPM1001</option>
                            </select>
							种类
							...
							TPM1001&nbsp;&nbsp;<input type="text" id="fyZldz" name="fangyuanEntity.fyZldz" class="ui_input_txt02" />
						</div>
						<div id="box_bottom">
